/**
 * Job board platform detection — keep in sync with
 * supabase/functions/_shared/job_platform.ts
 */
...
/** Detect Upwork, Indeed, or LinkedIn from pasted job text and optional link. */
