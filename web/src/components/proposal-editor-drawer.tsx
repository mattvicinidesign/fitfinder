...
export function ProposalEditorDrawer({
  ...
  return createPortal(
    ...
    >
      ...
      />
      <div className="relative flex h-full w-full min-w-0 max-w-[480px] flex-col justify-end overflow-hidden sm:justify-center sm:p-4">
        <div
          className={cn(
          ...
          <div className="min-h-0 min-w-0 flex-1 overflow-x-hidden overflow-y-auto overscroll-contain px-4 py-3">
            <Textarea
              ...
              className={cn(
                ...
                "border-0 bg-transparent px-3 py-1 text-[14px] leading-relaxed shadow-none",
