...
import { safeBottomLaunch, safeTopLaunch } from "@/lib/safe-area";
...
export function LaunchOverlayFrame({
  ...
  return (
    ...
    >
      <div className="relative flex h-full w-full max-w-[480px] flex-col overflow-x-hidden overflow-y-visible bg-background shadow-[0_0_0_1px_var(--border)]">
        <div
          className={cn(
