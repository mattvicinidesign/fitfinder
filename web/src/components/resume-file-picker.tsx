...
export type ResumeFilePickerHandle = {
  openFilePicker: () => void;
};
 ...
 */
export const ResumeFilePicker = forwardRef<ResumeFilePickerHandle, Props>(
  function ResumeFilePicker(
    { onParsed, onBusyChange, fileName, disabled, className, showReplaceHint = true },
    ref,
  ) {
