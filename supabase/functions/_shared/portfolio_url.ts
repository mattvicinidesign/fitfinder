...
/** Domains tied to employers/projects — not the candidate's personal portfolio. */
...
function isWorkOrProjectHost(host: string, resume?: ParsedResume | null): boolean {
  ...
  // .org is usually a product/client site unless it looks like a personal portfolio.
